...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    //      files: ['css/stylesheets/pxrem.css'],
    //      strict: {
    //        options: {
    //          "import": 2
    //        }
...
//          assets({
//            loadPaths: ['img/', 'fonts/']
//          }) //automatically add asset paths to something like dog.jpg - postcss-assets
                ]
    ...
    concat: {
      ...
      dist: {
        src: 'src/js/*.js',
        //file order is an issue to be solved still        src: ["src/js/vendor/jquery-1.12.0.min.js", "src/js/vendor/particles.js-master/particles.min.js", "src/js/plugins.js", "src/js/vendor/zenscroll-latest/zenscroll-min.js", "src/js/main.js"],
        dest: "js/concat.js"
      }
    },
